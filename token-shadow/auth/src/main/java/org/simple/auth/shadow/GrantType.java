...
public enum GrantType {
    CLIENT_CREDENTIALS("client_credentials",new OAuthRequestParameter[]{OAuthRequestParameter.CLIENT_ID,OAuthRequestParameter.CLIENT_SECRET}), REFRESH_TOKEN("refresh_token",new OAuthRequestParameter[]{OAuthRequestParameter.REFRESH_TOKEN}), IMPLICIT("implicit",new OAuthRequestParameter[]{OAuthRequestParameter.REDIRECT_URI,OAuthRequestParameter.CLIENT_ID});
